...
*
* v0.0.5
* BokkyPooBah / Bok Consulting Pty Ltd - Updated Solidity version, added `emit` keyword for events, reformatted
*
...
contract ProxyFactory {
    ...
    function createManyProxies(uint256 _count, address _target, bytes _data) public {
    ...
    function createProxyImpl(address _target, bytes _data) internal returns (address proxyContract) {
        assembly {
